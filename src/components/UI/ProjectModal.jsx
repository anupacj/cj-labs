        ...
        {submitted ? (
          <div className={styles.successState}>
            <span className={styles.successIcon}>
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#6f8fa3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
                <polyline points="22 4 12 14.01 9 11.01" />
              </svg>
            </span>
            <h2>Project Inquiry Received</h2>
            <p>Thank you for reaching out. Our studio reviews inquiries within 24 hours.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.fieldGroup}>
              <label className={styles.label}>1. Required Capabilities</label>
